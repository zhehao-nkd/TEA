classdef Archon
    ...
    methods(Static)
        ...
        % 把源数据的命名格式统一
        function reorderFilename(targetdir, ext) % rename filename, let bird id be the first
        ...
        function reorderDirname(targetdir) % rename dirname, let bird id be the first
