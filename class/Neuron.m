...
%                 end
    ...
    methods  % 作图方法
        ...
        function drawPC12(n)
            ...
            hold on
            scatter(n.sameChannelSpikes.pc1,n.sameChannelSpikes.pc2,1.5,'k','filled');
            scatter(n.wavepc(:,1),n.wavepc(:,2),1.5,'r','filled');
        end
        ...
        function drawValleyVsTime(n)
            ...
            if ismember('valley', n.sameChannelSpikes.Properties.VariableNames)
                figure('Position',n.figsize,'Color','w');
                hold on
                scatter(n.sameChannelSpikes.valley,n.sameChannelSpikes.timestamp,1.5,'k','filled')
                scatter(n.wavevalley,n.wavetimes,1.5,'r','filled');
