...
%%
    ...
    methods
            ...
            function obj=SAT_sound(y,fs)% constructor
                ...
                % added by Zhehao Cheng, 2023.0107 新添加的功能，计算meanfeatures
                obj.meanfeatures = obj.features;
                fnames = fieldnames(obj.meanfeatures);
                for k = 1:length(fnames)
                    obj.meanfeatures.(fnames{k}) = mean(obj.meanfeatures.(fnames{k}),'omitnan'); % 忽略nan值
                end
