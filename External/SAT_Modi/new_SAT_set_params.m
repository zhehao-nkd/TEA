...
%     if(exist('SAT_params.mat','file'))  % newly commented 1105,2022
%             load('SAT_params.mat');
%     else
%    
       ...
       % newly added . Zhehao 11052022
       SAT_params.segmentation_threshold = 0.0485;
       SAT_params.similarity_threshold = 2.5;
       SAT_params.similarity_interval = 10;
       SAT_params.similarity_section_min_dur = 7;
       SAT_params.calc_silence = 1;
       SAT_params.similarity_method = 1;
