function send_mail_message(address,subject,message,attachment)
...
mail = 'chengzh.work@gmail.com';    %Your GMail email address
password = 'fyrvwmkowooytupo';          %Your GMail password
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
