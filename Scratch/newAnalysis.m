...
b = Chorus(source(4).path_txt,source(4).path_plx,source(4).path_folder);
b.select;
neuronlist = b.getn;
...
b1 = Chorus(source(3).path_txt,source(3).path_plx,source(3).path_folder);
b1.select(1);
neuronlist = b1.getn;
...
b2 = Chorus(source(4).path_txt,source(4).path_plx,source(4).path_folder);
b2.select(1);
neuronlist = b2.getn;
