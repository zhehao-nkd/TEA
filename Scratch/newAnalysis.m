...
b = Chorus(source(4).path_txt,source(4).path_pl2,source(4).path_folder);
b.select;
neuronlist = b.getn;
...
% pl2 = 'E:\2021Recordings\Z0630_Y661\Y661_Z05.pl2';
% folder = 'Z:\Yazaki-SugiyamaU\Zhehao\My_Stimuli\Y661@06292021\Y661-1';

b1 = Chorus(source(3).path_txt,source(3).path_pl2,source(3).path_folder);
b1.select(1);
neuronlist = b1.getn;
list1 = neuronlist{1}.toList;




% txt = 'E:\2021Recordings\Z0630_Y661\Y661_Z06.txt';
% pl2 = 'E:\2021Recordings\Z0630_Y661\Y661_Z06.pl2';
% folder = 'Z:\Yazaki-SugiyamaU\Zhehao\My_Stimuli\Y661@06292021\Y661-2';

b2 = Chorus(source(4).path_txt,source(4).path_pl2,source(4).path_folder);
b2.select(1);
neuronlist = b2.getn;
list2 = neuronlist{1}.toList;
