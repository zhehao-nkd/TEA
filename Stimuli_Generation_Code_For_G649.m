...
%第一步  自动分割
tutbos_dir = "E:\Stimuli_Source\R693_twoMotif";
as = autoseg(tutbos_dir);
as.standard;

%第二部 检视 手动分割
dirpath = "E:\Stimuli_Source\R693_twoMotif\SegData";%"E:\Stimuli_Source\senatusTwoMotif\SegData";
...
TargetDir_specific_bird = "E:\R693_Special";
